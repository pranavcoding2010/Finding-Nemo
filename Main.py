...
nose bleed, which sends one of the sharks into a feeding frenz , and Marlin and Dory narrowly escape, but are knocked
unconscious when the sharks accidentally set off a ring of old naval mines."""
b = "teacher"
FindingNemo (string,b)